    ...
    <main className="px-2 md:px-4 lg:px-8 xl:px-12">
      ...
      <nav>
        <ul className="flex flex-col lg:flex-row gap-2 md:gap-4 lg:gap-8 xl:gap-16 justify-center items-center">
          ...
          <li>
            <CustomLink href='https://spinize.christiande.com/app'>
              Open web app
            </CustomLink>
          </li>
          <li>
      ...
      <Section id="why-spinize">
        <h2 className="mb-4 font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Why <Emphasis>Spinize</Emphasis>?</h2>
        <p className="text-gray-500 dark:text-gray-400">Spinize is a <b>free</b> subsonic client, compatible with Navidrome and <b>any subsonic compatible server</b>.</p>
        <p className="text-gray-500 dark:text-gray-400">Spinize offers an intuitive <b>user experience</b> and a pleasant <b>user interface</b>, because Music is meant to be art, and so should its client.</p>
      </Section>

      <Section id="about">
        <h2 className="mb-4 font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">More about the <Emphasis>Spinize project</Emphasis></h2>
        <p className="text-gray-500 dark:text-gray-400">Spinize was made because open source music servers need a nice <b>user interface</b> coupled with a nice <b>user experience</b>.</p>
        <p className="text-gray-500 dark:text-gray-400">This is why I started developing Spinize, and made it <b>free to use</b>.</p>
      </Section>

      <footer className="flex flex-col gap-1 justify-center items-center pb-16">
        <p className="text-center md:text-left">2025 The Spinize Project - a music client for subsonic servers.</p>
      </footer>
    </main>
  );
}
